 ...
 */
final class Version20191222045516 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD houseid INT DEFAULT NULL, CHANGE subject subject VARCHAR(50) DEFAULT NULL, CHANGE comment comment VARCHAR(255) DEFAULT NULL, CHANGE status status VARCHAR(10) DEFAULT NULL, CHANGE ip ip VARCHAR(20) DEFAULT NULL, CHANGE userid userid INT DEFAULT NULL, CHANGE cread_at cread_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE rate rate INT DEFAULT NULL');
